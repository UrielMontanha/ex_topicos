                ...
                <div class="row">
                    <div class="col s12">
                        <p class="center-align">
                            <button class="btn waves-effect waves-light #0d47a1 blue darken-4 white" type="submit" name="action"><i class="material-icons right white-t">send</i>Salvar</button>
                        </p>
                    </div>
                </div>
